        ...
        <div className={s.quizCreatorMain}>
          <div className={s.quizCreatorDiv}>
            ...
            <form onSubmit={this.submitHandler}>
              ...
              />
              <button type="button" disabled={!this.state.isFormValid} onClick={this.addQuestHandler}>Добавить вопрос</button>
              <button type="button" disabled={this.state.quiz.length === 0} onClick={this.createQuizHandler}>Создать тест</button>
            </form>
          </div>
        </div>
      )
