...
function SideBar() {
  return (
    <div className={s.side_bar}>
      <nav>
        <NavLink className={s.navLink} to='/profile' activeClassName={s.active}><li><i className="fa fa-home" aria-hidden="true"></i><span>Моя страница</span></li></NavLink>
        <NavLink className={s.navLink} to='/feed' activeClassName={s.active}><li><i className="fa fa-newspaper-o" aria-hidden="true"></i><span>Новости</span></li></NavLink>
        <NavLink className={s.navLink} to='/dialogs' activeClassName={s.active}><li><i className="fa fa-comments" aria-hidden="true"></i><span>Сообщения</span></li></NavLink>
        <NavLink className={s.navLink} to='/friends' activeClassName={s.active}><li><i className="fa fa-user" aria-hidden="true"></i><span>Друзья<span className={s.count} >3</span></span></li></NavLink>
        <NavLink className={s.navLink} to='/groups' activeClassName={s.active}><li><i className="fa fa-users" aria-hidden="true"></i><span>Сообщества</span></li></NavLink>
        <NavLink className={s.navLink} to='/photos' activeClassName={s.active}><li><i className="fa fa-camera" aria-hidden="true"></i><span>Фотографии</span></li></NavLink>
        ...
        <NavLink className={s.navLink} to='/game' activeClassName={s.active}><li><i className="fa fa-gamepad" aria-hidden="true"></i><span>Игры</span></li></NavLink>
        <hr></hr>
